...
import 'package:stitchtv_app/app/constant.dart';
import 'package:stitchtv_app/app/controller/app_settings_controller.dart';
import 'package:stitchtv_app/app/controller/base_controller.dart';
import 'package:stitchtv_app/app/event_bus.dart';
import 'package:stitchtv_app/app/log.dart';
import 'package:stitchtv_app/app/utils.dart';
import 'package:stitchtv_app/app/utils/archive.dart';
import 'package:stitchtv_app/app/utils/document.dart';
import 'package:stitchtv_app/models/db/follow_user.dart';
import 'package:stitchtv_app/models/db/follow_user_tag.dart';
import 'package:stitchtv_app/models/db/history.dart';
import 'package:stitchtv_app/modules/sync/remote_sync/webdav/webdav_client.dart';
import 'package:stitchtv_app/services/bilibili_account_service.dart';
import 'package:stitchtv_app/services/db_service.dart';
import 'package:stitchtv_app/services/local_storage_service.dart';
...
class RemoteSyncWebDAVController extends BaseController {
  ...
  final _userFollowJsonName = 'StitchTV_follows.json';
  final _userHistoriesJsonName = 'StitchTV_histories.json';
  final _userBlockedWordJsonName = 'StitchTV_blocked_word.json';
  final _userBilibiliAccountJsonName = 'StitchTV_bilibili_account.json';
  final _userSettingsJsonName = 'StitchTV_Settings.json';
  final _userTagsJsonName = 'StitchTV_Tags.json';
